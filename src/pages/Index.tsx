        ...
        <div className="section-container">
          ...
          <div className="faq-section">
            ...
            <div className="faq-item">
              ...
              <p className="text-muted-foreground font-body leading-relaxed">Our team members are certified in various cleaning techniques and use eco-friendly products to ensure a safe and effective cleaning experience.</p>
            </div>
            <div className="faq-item">
              <h3 className="cursor-pointer text-primary font-semibold">Can I request a specific team member for my cleaning service?</h3>
