        ...
        <div className="section-container">
          ...
          <div className="faq-section">
            ...
            <div className="faq-item">
              ...
              <p className="text-muted-foreground font-body leading-relaxed">Our team members are certified in professional cleaning techniques and are trained to use eco-friendly products.</p>
            </div>
            <div className="faq-item">
