        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-100 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-4">98% Customer Satisfaction Rate</h3>
              <p className="text-gray-700">Our customers love our service, with a satisfaction rate of 98%! <a href="#source" className="text-blue-500 underline">See the survey results</a>.</p>
            </div>
            <div className="bg-gray-100 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-4">500+ Homes Cleaned in 2024</h3>
              <p className="text-gray-700">We have successfully cleaned over 500 homes this year alone, ensuring top-notch service and customer care.</p>
            </div>
          </div>
        </div>
      </section>
