          ...
          {`
            {
              ...
              "@type": "LocalBusiness",
              "name": "SparkClean",
              "image": "https://sparkclean-geo-aeo.lovable.app/images/logo.png",
              ...
              "sameAs": [
                ...
                "https://www.instagram.com/SparkClean"
              ]
            }
          `}
        </script>
          ...
          {`
            {
              ...
              "offers": {
                "@type": "Offer",
                "url": "https://sparkclean-geo-aeo.lovable.app/services/home-cleaning",
                "priceCurrency": "USD",
                "price": "100",
                "eligibleRegion": {
                  "@type": "Place",
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-6">
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <img src="path-to-image.jpg" alt="Author Name" className="w-full h-32 object-cover rounded-t-lg" />
              <div className="p-4">
                <h3 className="text-xl font-semibold">Author Name</h3>
                <p className="text-gray-600">Role/Position</p>
                <p className="mt-2 text-gray-700">Brief bio goes here. This should include relevant experience and expertise.</p>
                <a href="https://linkedin-profile-url" className="text-blue-500 hover:underline mt-2 block">LinkedIn Profile</a>
              </div>
            </div>
          </div>
